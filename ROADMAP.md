...
- [x] **Yale Lock State Protection:** Updated MBR Bedtime and Away arming automations with a dynamic template guard that filters out already locked/locking deadbolts, resolving a Yale Assure 2 state-hanging issue where redundant lock commands left entities permanently in a "locking" state (Completed June 29, 2026).
